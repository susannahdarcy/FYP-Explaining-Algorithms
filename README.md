This is the code repository for Susannah D'Arcy's final year project. The project goals was to create an interface to aid in the understanding of algorithms, and their trade-offs.
